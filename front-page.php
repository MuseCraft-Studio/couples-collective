...
<head>
    <title>The Couples Collective</title>
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="The Couples Collective">
...
<body data-page="home">
        ...
        <div class="container">
            <div class="video-container">
                <video autoplay muted loop id="myVideo">
                    <source src="/wordpress/wp-content/themes/cjtest/assets/images/Stocksy_txp43f09b8fmIk300_h264_1080p_4516097.mp4" type="video/mp4">
                </video>
            </div>
            <div class="header">
            ...
            <div class="left-content">
                ...
                <div class=".button-row">
                    ...
                    <button class="outline-button">Individuals</button>
                </div>
            </div>
        </div>
    </div>
    <div id="section-two">
        <div class="flex-container">
            ...
            <div class="image"></div>
            <!-- <img src="/assets/Stocksy_txp2c7f6af1x1k200_Small_148595.jpg" /> -->
            <!-- </div> -->
            ...
            <div class="get-started">
                ...
                <div>
                    <button class="fill-button">Get Started</button>
                </div>
            </div>
        </div>
    </div>
    <div id="section-three">
        <div class="background">
            ...
            <img src="assets/Stocksy_txp2c7f6af1x1k200_Small_3207612.jpg" class="cover-img" />
            <div class="title">
                Reviews on Yelp
            </div>
            <div class="flex-container">
                <div class="flex-item">
                    <div class="svg-container">
                        <div>
                            <img src="assets/yelp_star.svg" alt="yel-star">
                        </div>
                        <div>
                            <img src="assets/yelp_star.svg" alt="yel-star">
                        </div>
                    ...
                    <div class="review">
                        "He often pushes us to examine our relationship from new angles and see things we wouldn't have
                        otherwise noticed."
                    </div>
                </div>
                <div class="flex-item">
            ...
            <div class="flex-container">
                <div class="flex-item">
                    ...
                    <div class="review">
                        "Recommend for anyone looking for a very good counselor in general. [...] He is someone I hold
                        in
                        high regard and respect his work and dedication to helping others through tough spots in their
                        lives."
                    </div>
                </div>
                <div class="flex-item">
                    ...
                    <div class="review">
                        "I honestly believe that I would not be where I am today without Grady's guidance. He has been
    ...
    <div id="section-five">
        <div class="container">
            ...
            <div class="image"></div>
            <!-- <img src="/assets/Stocksy_txp2c7f6af1x1k200_Small_2750090.jpg" /> -->
        </div>
    </div>
    <div id="footer">
        <div class="container">
