    ...
    <div id="full-page">
        <div id="work-with-us">
            ...
            <div class="flex-container-left">
                <div class="flex-item">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/careers/rock.jpg" alt="woman holding heart shaped rock"/>
                </div>
                <div class="flex-item">
                    <div class="title">Requirements for our candidates</div>
                    <ul>
                        <li>As we primarily utilize Emotionally Focused Therapy (EFT), we require our associates and licensed clinicians to have completed an EFT externship before working with our practice. An interest in making EFT the focus of couples work is also essential.</li>
                        <li>The clinician must be an associate or licensed clinician in the state of California in good standing with their board.</li>
                        <li>The clinician must hold their own personal liability insurance.</li>
                        <li>Associates and Licensed clinicians are expected to hold availability for client sessions for at least one evening per week, and to be available for in-person sessions at our East Bay Oakland location at least two days per week. Hybrid options are available outside of those limitations.</li>
